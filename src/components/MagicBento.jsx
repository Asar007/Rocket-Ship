...
export default function MagicBento({
  ...
  return (
    <>
      ...
      <div className="mb-card-grid mb-section" ref={gridRef}>
        {items.map((item, index) => {
          const baseClassName = `mb-card ${enableBorderGlow ? 'mb-card--border-glow' : ''}`
          const cardStyle = { '--mb-glow': glowColor }
          ...
          const inner = (
            <>
              ...
              <span className="mb-card__name">{item.name}</span>
            </>
          )
          ...
          return (
            <div key={`${item.name}-${index}`} className={baseClassName} style={cardStyle}>
              {inner}
            </div>
          )
        })}
